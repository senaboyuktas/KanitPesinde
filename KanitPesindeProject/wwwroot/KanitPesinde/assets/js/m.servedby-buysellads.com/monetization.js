var _bsa = {
  init: function (format, zoneKey, segment, options) {
    ...
    if (
      _bsa[format].readyToInit != false &&
      this.nativeFormats.indexOf(format) !== -1
    ) {
      var self = this;
      this.userIsBlockingNonAcceptableAdsAsync(function (
        userIsBlockingNonAcceptableAds
      ) {
        if (userIsBlockingNonAcceptableAds) {
          self.recordAcceptableAdImpression(_bsa.srv(), segment, options);
        }
      });
    }
  },
  ...
  userIsBlockingNonAcceptableAdsAsync: (function () {
    var adBlockDetected;
    return function userIsBlockingNonAcceptableAdsAsync(callback) {
      if (typeof adBlockDetected !== "undefined") {
        callback(adBlockDetected);
        return;
      }
      var px = "https://cdn4.buysellads.net/acceptable.gif?ch=*&rn=*";
      var detected = false;
      var checksRemain = 2;
      var error1 = false;
      var error2 = false;
      function beforeCheck(timeout) {
        if (checksRemain === 0 || timeout > 1e3) {
          adBlockDetected = checksRemain === 0 && detected;
          callback(adBlockDetected);
        } else {
          setTimeout(function () {
  ...
  recordAcceptableAdImpression: function (baseurl, segment, options) {
    var req = new XMLHttpRequest();
    var zoneKey = "CEAICK3E";
    var forcebanner = "453089";
    var url = this._buildSrvUrl(
      "//" + baseurl + "/ads/" + zoneKey + ".json",
      segment,
      options,
      forcebanner
    );
...
_bsa.flexbar = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    style +=
      ...
      id +
      "._bsa_hide{margin-bottom:0;min-height:initial}#" +
      id +
      " ._bsa_flexbar{position:relative;z-index:999999;width:100%;background:" +
      backgroundColor +
      ';text-align:left;min-height:90px;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",Helvetica,Arial,sans-serif !important;-webkit-animation:fadein 2s;-moz-animation:fadein 2s;-ms-animation:fadein 2s;-o-animation:fadein 2s;animation:fadein 2s}#' +
      id +
      ...
      id +
      " .flexbar-logo img{margin:0 30px 0 0;width:125px;max-width:125px}#" +
      id +
      ...
      id +
      " .flexbar-logo img{width:100px;max-width:100px}#" +
      id +
...
_bsa.hellobar = function (zoneKey, segment, options, ads) {
  ...
  function template(ads) {
    ...
    c +=
      '<div class="hello-desc">Supported by ' +
      ad.company +
      " â€” " +
      ad.description +
      "</div>";
    c += "</a>";
    c +=
      '<span class="hello-hide" style="background-color: ' +
      ad.ctaBackgroundColor +
      "; color: " +
      ad.ctaTextColor +
      '" onclick="_bsa.close(\'' +
      _bsa.hellobar.elID(options) +
      "', 1000 * 60 * 60)\">Hide</span>";
    c += "</section>";
...
_bsa.stickybox = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    c +=
      ...
      id +
      " .stickybox-outer{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,Helvetica,Arial,sans-serif;font-size:12px;max-width:400px;box-shadow:inset 0 0 0 1px hsla(0,0%,100%,0.15);position:fixed;bottom:20px;right:20px;z-index:1000}#" +
      id +
      " .stickybox-inner{display:flex;background-color:#121212;padding:.8em;border-radius:4px;text-decoration:none}#" +
      id +
      " .stickybox-banner{position:relative;display:grid;place-content:center center;padding:1em;margin-right:1em;border-radius:4px}#" +
      id +
      " .stickybox-logo{width:auto;height:50px;max-width:none}#" +
      id +
      " .stickybox-description{margin-bottom:.5em;font-size:14px;line-height:1.35;color:hsl(0,0%,95%);text-align:left}#" +
      id +
      " .stickybox-company{font-weight:600;text-transform:uppercase;font-size:10px;color:hsl(0,0%,60%);letter-spacing:.4px}#" +
      id +
      ...
      id +
      " .native-hide{cursor:pointer;position:absolute;top:-6px;right:-6px;height:18px;width:18px;display:grid;place-content:center center;border-radius:50%}@media only screen and (max-width:667px){#" +
      id +
      " .stickybox-outer{max-width:initial}#" +
      id +
      " .stickybox-logo{height:20px}#" +
      id +
      " .stickybox-outer{font-size:10px;left:1em;right:1em;bottom:1em}#" +
      id +
      " .stickybox-cta{display:none}}";
    if (_bsa.isset(ads[0].custom_css)) c += ads[0].custom_css;
    c += "</style>";
    return c;
  }
  function template(ads) {
    ...
    c +=
      ...
      '\')"><svg fill="' +
      backgroundColor +
      '" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="12" height="12"><path d="M7 4a.995.995 0 0 0-.707.293l-2 2a.999.999 0 0 0 0 1.414L11.586 15l-7.293 7.293a.999.999 0 0 0 0 1.414l2 2a.999.999 0 0 0 1.414 0L15 18.414l7.293 7.293a.999.999 0 0 0 1.414 0l2-2a.999.999 0 0 0 0-1.414L18.414 15l7.293-7.293a.999.999 0 0 0 0-1.414l-2-2a.999.999 0 0 0-1.414 0L15 11.586 7.707 4.293A.996.996 0 0 0 7 4z"/></svg></div>';
    c += "<div>";
    c += pixel;
    return c;
  }
